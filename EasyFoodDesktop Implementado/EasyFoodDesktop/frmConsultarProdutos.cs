    ...
    public partial class frmConsultarProdutos : Form
    {
        ...
        private void btnPesquisar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    sqlComm = new MySqlCommand("SELECT CodProd Codigo, NomeProd Nome, PrecoProd Preco FROM PRODUTOS WHERE nomeProd LIKE @nome", connBD);
                ...
                {
                    sqlComm = new MySqlCommand("SELECT CodProd Codigo, NomeProd Nome, PrecoProd Preco FROM PRODUTOS WHERE codProd = @codigo", connBD);
                    sqlComm.Parameters.Clear();
        ...
        private void frmConsultarProdutos_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                MySqlCommand sqlComm = new MySqlCommand("SELECT codProd Codigo, nomeTipoProd 'Tipo de Produto', nomeProd Nome, precoProd Preco FROM PRODUTOS, TIPOPRODUTOS WHERE codTipoProdFK = codTipoProd", connBD);
